...
//      filename = "/home/fac/ohsh/submit/21wq5001/files/p3input.txt";
    ...
    * @throws IOException
    */
   public static void play(Scanner keyboard) throws IOException {
   ...
   /**
    * Writes the winner to a txt file
    *
    * @param winner The game winner for each game
    * @throws IOException
    */
   public static void writeWinner(String winner)
         throws IOException {
      // create a FileWriter and PrintWriter object
      FileWriter fileWriter = new FileWriter("winnerList.txt", true);
      PrintWriter outputFile = new PrintWriter(fileWriter);
      outputFile.println(winner);
   ...
   /**
    * Displays the winner list
    *
    * @throws IOException
    */
   public static void displayWinner() throws IOException {
      final int TEN = 10;
      int lastIndex;
...
//         }
//      } else {
//         for (int i = winnerList.size() - 1; i > winnerList.size() - 1 - TEN; i--) {
//            System.out.print(winnerList.get(i) + " ");
//         }
//      }

      lastIndex = winnerList.size() - 1;
      // print out last 10 winners
      System.out.println("WINNER LIST: ");
      for (int i = lastIndex; i >= 0; i--) {
         for (int j = lastIndex - 1; j < 0; j++) {
            while (winnerList.get(j) == winnerList.get(i)) {
               winnerList.remove(j);
            }
         }
      }
      ...
      if (winnerList.size() <= TEN) {
         ...
         for (int i = lastIndex; i >= lastIndex - TEN; i++) {
